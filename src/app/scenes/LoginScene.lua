...
function LoginScene:fun_endanimation(_obj,_image,_type,_istrue)   
      ...
      spark:setPosition(cc.p(_content:getPositionX()-  _type-6,_content:getPositionY()+5));
     -- spark:setColor(cc.c3b(250,100,30))
      ...
      local moveTo = cc.MoveTo:create(4,cc.p(_content:getPositionX()+_type,_content:getPositionY()+4))
      local moveBack = cc.MoveTo:create(4,cc.p(_content:getPositionX()-_type,_content:getPositionY()+4))  --moveTo:reverse()  --
