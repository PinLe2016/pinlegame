...
function aboutdetailsLayer:businesscooperation( )
    ...
    self.companyname_text:setText("请输入公司名称")
    ...
    self.nametext:setText("请输入联系人姓名")
    ...
    self.phonetext:setText("请输入联系方式")
...
function aboutdetailsLayer:inputbox(  )
    ...
    self.phone_text:setText("请输入手机号码")
